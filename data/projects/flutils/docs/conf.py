...
latex_documents = [
    (master_doc, 'flutils.tex', 'flutils Documentation',
     'Finite Loop, LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'flutils', 'flutils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'flutils', 'flutils Documentation',
     author, 'flutils', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context = {
    ...
    "gitlab_user": "finite-loop",  # Username
    "gitlab_repo": "flutils",  # Repo name
